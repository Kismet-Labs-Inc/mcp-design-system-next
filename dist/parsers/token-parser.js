 ...
 */
export function parseColors(assetsPath) {
 ...
 */
export function parseSpacing(assetsPath) {
 ...
 */
export function parseBorderRadius(assetsPath) {
 ...
 */
export function parseMaxWidth(assetsPath) {
 ...
 */
export function getAllTokens(assetsPath) {
    return {
